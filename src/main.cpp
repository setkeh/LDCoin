...
uint256 hashGenesisBlock("0x0fc3cc576f63725b5e129d8e405588b976e6226151a3e2edade077a9a7109f0a");
...
const string strMessageMagic = "LdcCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // LdcCoin: 1 days
static const int64 nTargetSpacing = 120; // LdcCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal LDCcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "LdcCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x0fc3cc576f63725b5e129d8e405588b976e6226151a3e2edade077a9a7109f0a");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Bill Gates: I hope you Aussies are proud of yourselves - I am";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1369697731; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1032983;
        ...
        assert(block.hashMerkleRoot == uint256("0x28a79812e752f5489cb55526539395955b426b67efc8c35091c4a6db751f1d12"));
